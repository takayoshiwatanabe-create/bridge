...
export const translations: Translations = {
  ja: {
    ...
    "common.data_source": "{{source}} | {{time}} | {{delay}}",
  ...
  en: {
    ...
    "common.data_source": "{{source}} | {{time}} | {{delay}}",
    "common.delay_minutes": "{{minutes}} minutes delay",
  ...
  es: {
    ...
    "common.data_source": "{{source}} | {{time}} | {{delay}}",
    "common.delay_minutes": "{{minutes}} minutos de retraso",
  ...
  fr: {
    ...
    "common.data_source": "{{source}} | {{time}} | {{delay}}",
    "common.delay_minutes": "{{minutes}} minutes de retard",
  ...
  de: {
    ...
    "common.data_source": "{{source}} | {{time}} | {{delay}}",
    "common.delay_minutes": "{{minutes}} Minuten Verzögerung",
  ...
  pt: {
    ...
    "common.data_source": "{{source}} | {{time}} | {{delay}}",
    "common.delay_minutes": "{{minutes}} minutos de atraso",
